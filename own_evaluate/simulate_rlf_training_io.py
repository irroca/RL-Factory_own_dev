...
def simulate_without_tokenizer() -> None:
    ...
    # Also show what the eval script's searchr1_multiturn mode now produces
    print()
    print("=" * 80)
    print("COMPARISON: eval script searchr1_multiturn mode (after fix)")
    print("  Should produce IDENTICAL sequence to training above.")
    print("=" * 80)
    print()
    print("  Turn 1 prompt (build_initial_prompt_searchr1_multiturn):")
    print(f"    = initial_prompt (same as above)")
    print()
    print("  After Turn 1 search:")
    print("    accumulated_prompt += raw_output + '<|im_end|>' + info_text")
    print("    = initial_prompt + model_output + '<|im_end|>' + '\\n\\n<information>...\\n</information>\\n\\n'")
