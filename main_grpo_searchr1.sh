...
export RESULT_DIR=/scratch/azureml/cr/j/67c9cb676caf4c9daa27e59f014d7dd8/exe/wd/Search_agent_data/RLF_checkpoints/rl_factory/search_r1_aligned_format_reward
...
python3 -m verl.trainer.main_ppo --config-name=rl_factory_ppo_trainer \
    ...
    trainer.experiment_name='search_r1_Qwen3-0.6B_aligned_format_reward'\
    ...
    trainer.total_training_steps=400 $@ 2>&1 | tee grpo_searchr1.log
